    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={()=>setOpen(false)}>
                <img className="h-10" src='../assets/logo.png' alt="GizmoLK Logo" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    ...
                    <img src='../assets/search_icon.svg' alt="Search Icon" className="h-5 w-5" />
                </div>

                <div onClick={()=> navigate('/cart')} className="relative cursor-pointer">
                    <img src={assets.cart_icon} alt="GizmoLK Cart" className="w-6 opacity-85" />
                    ...
                    !user ?
                        (<button onClick={()=>setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
                            ...
                            <div className='relative group'>
                                <img src='../assets/profile_icon.png' alt="Profile Icon" className="w-10" />
            ...
            <div className="flex items-center gap-4 sm:hidden">
                ...
                <button onClick={() => open ? setOpen(false) : setOpen(true)} aria-label="Menu" className="sm:hidden">
                    {/* Menu Icon SVG */}
                    <img className='ml-2' src='../assets/menu_icon.svg' alt="Menu" />
                </button>
            </div>
