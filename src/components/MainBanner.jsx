...
const MainBanner = () => {
    return (
        <div className='relative'>
            <img className="w-full hidden md:block" src={assets.main_banner_bg} alt="main banner bg" />
            <img className="w-full md:hidden" src={assets.main_banner_bg_sm} alt="main banner bg sm" />
